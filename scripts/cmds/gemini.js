...
const baseCacheDir = path.join(__dirname, "cacher", "ai");
...
module.exports = {
  ...
  onStart: async function ({ message, event, args }) {
    ...
    try {
      ...
      const res = await axios.get(`https://alit-x-api.onrender.com/api/gemini2.00text?text=${encodeURIComponent(prompt)}`);
